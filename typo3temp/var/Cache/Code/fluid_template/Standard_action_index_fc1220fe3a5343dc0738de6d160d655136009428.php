...
class Standard_action_index_fc1220fe3a5343dc0738de6d160d655136009428 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$arguments148['partial'] = 'Shopkategorien';
...
$array152 = array (
);return $renderingContext->getVariableProvider()->getByPath('content1', $array152);
};
$arguments150 = array();
...
$expression146 = function($context) {return (($context["node0"]) == '52');};
...
$output139 .= TYPO3Fluid\Fluid\ViewHelpers\IfViewHelper::renderStatic($arguments142, $renderChildrenClosure143, $renderingContext);
...
$array155 = array (
);return $renderingContext->getVariableProvider()->getByPath('content1', $array155);
};
$arguments153 = array();
$arguments153['value'] = NULL;

$output139 .= isset($arguments153['value']) ? $arguments153['value'] : $renderChildrenClosure154();
...
$arguments156 = array();
$arguments156['typoscriptObjectPath'] = NULL;
$arguments156['data'] = NULL;
$arguments156['currentValueKey'] = NULL;
$arguments156['table'] = '';
$arguments156['typoscriptObjectPath'] = 'lib.subnavigation';

$output139 .= TYPO3\CMS\Fluid\ViewHelpers\CObjectViewHelper::renderStatic($arguments156, $renderChildrenClosure157, $renderingContext);
