...
class Standard_action_index_69df8fc0fd9e64aa895a1decf8af7b4b1def42b8 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output0 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('id', $array1), ENT_QUOTES);

$output0 .= '" data-store-last-tab="';
$array2 = array (
);
$output0 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('storeLastActiveTab', $array2), ENT_QUOTES);
...
$array15['1'] = ' == ';
$array17 = array (
);$array15['2'] = htmlspecialchars($renderingContext->getVariableProvider()->getByPath('defaultTabIndex', $array17), ENT_QUOTES);
...
$output12 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('id', $array19), ENT_QUOTES);
...
$output12 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('id', $array22), ENT_QUOTES);
...
$array65['1'] = ' == ';
$array67 = array (
);$array65['2'] = htmlspecialchars($renderingContext->getVariableProvider()->getByPath('defaultTabIndex', $array67), ENT_QUOTES);
...
$output62 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('id', $array69), ENT_QUOTES);
