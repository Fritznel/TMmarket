...
class partial_Media_Gallery_03c1ffa21bac46e537951a90ada08818b3b6dc6e extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output6 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('gallery.count.columns', $array12), ENT_QUOTES);

$output6 .= '" data-ce-images="';
$array13 = array (
);
$output6 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('gallery.count.files', $array13), ENT_QUOTES);
...
$expression18 = function($context) {return (($context["node0"]) == 'center');};
...
$expression44 = function($context) {return (($context["node0"]) == 'center');};
