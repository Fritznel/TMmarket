...
class Standard_action_index_75e4aa447d4b15c567645d3db5b9558f2711b46f extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$array41 = array();
$array42 = array (
);$array41['0'] = $renderingContext->getVariableProvider()->getByPath('data.uid', $array42);
$array41['1'] = '==\'51\'';

$expression43 = function($context) {return (($context["node0"]) == '51');};
...
$arguments56['partial'] = 'Shopkategorien';
...
$expression54 = function($context) {return (($context["node0"]) == '52');};
...
$output36 .= TYPO3Fluid\Fluid\ViewHelpers\IfViewHelper::renderStatic($arguments61, $renderChildrenClosure62, $renderingContext);
...
$output36 .= TYPO3Fluid\Fluid\ViewHelpers\IfViewHelper::renderStatic($arguments72, $renderChildrenClosure73, $renderingContext);
...
$output36 .= TYPO3Fluid\Fluid\ViewHelpers\IfViewHelper::renderStatic($arguments83, $renderChildrenClosure84, $renderingContext);
...
$output36 .= TYPO3Fluid\Fluid\ViewHelpers\IfViewHelper::renderStatic($arguments94, $renderChildrenClosure95, $renderingContext);
...
$output139 .= isset($arguments147['value']) ? $arguments147['value'] : $renderChildrenClosure148();
...
$arguments153 = array();
$arguments153['typoscriptObjectPath'] = NULL;
$arguments153['data'] = NULL;
$arguments153['currentValueKey'] = NULL;
$arguments153['table'] = '';
$arguments153['typoscriptObjectPath'] = 'lib.rootline';

$output152 .= TYPO3\CMS\Fluid\ViewHelpers\CObjectViewHelper::renderStatic($arguments153, $renderChildrenClosure154, $renderingContext);
...
$arguments161['partial'] = 'Bezahlung';
...
$expression159 = function($context) {return (($context["node0"]) == '51');};
...
$output152 .= TYPO3Fluid\Fluid\ViewHelpers\IfViewHelper::renderStatic($arguments155, $renderChildrenClosure156, $renderingContext);
...
$arguments172['partial'] = 'Shopkategorien';
...
$expression170 = function($context) {return (($context["node0"]) == '52');};
...
$output152 .= TYPO3Fluid\Fluid\ViewHelpers\IfViewHelper::renderStatic($arguments166, $renderChildrenClosure167, $renderingContext);
...
$output152 .= TYPO3Fluid\Fluid\ViewHelpers\IfViewHelper::renderStatic($arguments177, $renderChildrenClosure178, $renderingContext);
...
$output152 .= TYPO3Fluid\Fluid\ViewHelpers\IfViewHelper::renderStatic($arguments188, $renderChildrenClosure189, $renderingContext);
...
$output152 .= TYPO3Fluid\Fluid\ViewHelpers\IfViewHelper::renderStatic($arguments199, $renderChildrenClosure200, $renderingContext);
...
$output152 .= TYPO3Fluid\Fluid\ViewHelpers\IfViewHelper::renderStatic($arguments210, $renderChildrenClosure211, $renderingContext);
