...
class Standard_action_NoTemplate_e6a23e3b66a9b66e5fb744e5cf5e778b9f0e18e1 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output0 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('content.actionName', $array1), ENT_QUOTES);
...
$output7 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments8, $renderChildrenClosure9, $renderingContext), ENT_QUOTES);
...
$output7 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments10, $renderChildrenClosure11, $renderingContext), ENT_QUOTES);
...
$output0 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('staticsText', $array14), ENT_QUOTES);
...
$renderChildrenClosure18 = $arguments17['content'] ? function() use ($arguments17) { return $arguments17['content']; } : $renderChildrenClosure18;
$output0 .= htmlspecialchars(TYPO3Fluid\Fluid\ViewHelpers\OrViewHelper::renderStatic($arguments17, $renderChildrenClosure18, $renderingContext), ENT_QUOTES);
...
$output0 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments22, $renderChildrenClosure23, $renderingContext), ENT_QUOTES);
...
$output0 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments24, $renderChildrenClosure25, $renderingContext), ENT_QUOTES);
...
$output0 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments28, $renderChildrenClosure29, $renderingContext), ENT_QUOTES);
...
$output35 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments36, $renderChildrenClosure37, $renderingContext), ENT_QUOTES);
...
$output35 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments38, $renderChildrenClosure39, $renderingContext), ENT_QUOTES);

$output35 .= '</p>
            <a class="btn btn-default" href="';
$array43 = array (
);
$output35 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('content.previousPage.aHref', $array43), ENT_QUOTES);
...
$output35 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments44, $renderChildrenClosure45, $renderingContext), ENT_QUOTES);
