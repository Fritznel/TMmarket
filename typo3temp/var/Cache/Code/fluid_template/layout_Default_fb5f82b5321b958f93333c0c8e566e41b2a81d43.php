...
class layout_Default_fb5f82b5321b958f93333c0c8e566e41b2a81d43 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output133 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('data.uid', $array134), ENT_QUOTES);

$output133 .= '" class="frame frame-';
$array135 = array (
);
$output133 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('data.frame_class', $array135), ENT_QUOTES);

$output133 .= ' frame-type-';
$array136 = array (
);
$output133 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('data.CType', $array136), ENT_QUOTES);

$output133 .= ' frame-layout-';
$array137 = array (
);
$output133 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('data.layout', $array137), ENT_QUOTES);
// Rendering ViewHelper TYPO3Fluid\Fluid\ViewHelpers\IfViewHelper
...
$output143 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('data.space_before_class', $array144), ENT_QUOTES);
...
$output150 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('data.space_after_class', $array151), ENT_QUOTES);
...
$output157 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('data._LOCALIZED_UID', $array158), ENT_QUOTES);
...
$output197 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('data.uid', $array198), ENT_QUOTES);
...
$output204 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('data._LOCALIZED_UID', $array205), ENT_QUOTES);
...
$output211 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('data.space_before_class', $array212), ENT_QUOTES);
...
$output254 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('data.space_after_class', $array255), ENT_QUOTES);
...
$output30 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('data._LOCALIZED_UID', $array31), ENT_QUOTES);
...
$output68 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('data.uid', $array69), ENT_QUOTES);
...
$output75 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('data._LOCALIZED_UID', $array76), ENT_QUOTES);
...
$output82 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('data.space_before_class', $array83), ENT_QUOTES);
...
$output125 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('data.space_after_class', $array126), ENT_QUOTES);
