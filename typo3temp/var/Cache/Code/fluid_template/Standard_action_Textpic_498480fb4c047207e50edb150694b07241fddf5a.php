...
class Standard_action_Textpic_498480fb4c047207e50edb150694b07241fddf5a extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$expression5 = function($context) {return (($context["node0"]) != 1);};
...
$output10 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('gallery.position.horizontal', $array11), ENT_QUOTES);

$output10 .= ' ce-';
$array12 = array (
);
$output10 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('gallery.position.vertical', $array12), ENT_QUOTES);
// Rendering ViewHelper TYPO3Fluid\Fluid\ViewHelpers\IfViewHelper
...
$output23 .= TYPO3Fluid\Fluid\ViewHelpers\RenderViewHelper::renderStatic($arguments24, $renderChildrenClosure25, $renderingContext);
...
$expression22 = function($context) {return (($context["node0"]) != 'below');};
...
$output35 .= TYPO3Fluid\Fluid\ViewHelpers\RenderViewHelper::renderStatic($arguments36, $renderChildrenClosure37, $renderingContext);
...
$expression99 = function($context) {return (($context["node0"]) == 'below');};
...
$expression114 = function($context) {return (($context["node0"]) != 1);};
...
$output121 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('gallery.position.horizontal', $array122), ENT_QUOTES);

$output121 .= ' ce-';
$array123 = array (
);
$output121 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('gallery.position.vertical', $array123), ENT_QUOTES);
// Rendering ViewHelper TYPO3Fluid\Fluid\ViewHelpers\IfViewHelper
...
$expression133 = function($context) {return (($context["node0"]) != 'below');};
...
$output202 .= TYPO3Fluid\Fluid\ViewHelpers\RenderViewHelper::renderStatic($arguments203, $renderChildrenClosure204, $renderingContext);
...
$expression171 = function($context) {return ($context["node0"]);};
...
$expression145 = function($context) {return ($context["node0"]);};
...
$output165 .= TYPO3Fluid\Fluid\ViewHelpers\RenderViewHelper::renderStatic($arguments166, $renderChildrenClosure167, $renderingContext);
...
$expression164 = function($context) {return ($context["node0"]);};
...
$expression158 = function($context) {return ($context["node0"]);};
...
$expression210 = function($context) {return (($context["node0"]) == 'below');};
